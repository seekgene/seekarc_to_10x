...
class Reader(Process):
    def __init__(self, file1:str, file2:str, connections, queue:Queue, buffer_size:int):
        super().__init__()
        self.file1 = file1
        self.file2 = file2
...
class Pipeline:
    ...
    def run(self):
        ...
        for index in range(self.n_workers):
            ...
            worker = Worker(index, _pipes[index], conn_w, self.need_work_queue, self.func, self.paired_out)
            worker.daemon = True
            worker.start()
